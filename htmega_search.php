...
class HTMega_Elementor_Widget_Search extends Widget_Base {
    ...
    public function get_title() {
        return __( 'Введите трек-номер', 'htmega-addons' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            'search_content',
            [
                'label' => __( 'Введите трек-номер', 'htmega-addons' ),
            ]
        );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default' => __( 'Введите трек-номер', 'htmega-addons' ),
                    'placeholder' => __( 'Введите трек-номер', 'htmega-addons' ),
                ]
            );
    ...
    protected function render( $instance = [] ) {
        ...
        $this->add_render_attribute(
            'input_attr', [
                ...
                'type' => 'text',
                'name' => 's',
                'title' => esc_html__( 'Введите трек-номер', 'htmega-addons' ),
